    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <p className="text-[#95d5b2]/70 text-base">Hành trình ngàn năm âm nhạc bắt đầu từ đây</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-2xl font-bold text-[#0a1f14] mb-1">Tạo tài khoản</h1>
          <p className="text-[#2d6a4f]/60 text-sm mb-8">
            Đã có tài khoản?{" "}
            <Link href="/login" className="text-[#52b788] font-medium hover:underline">
              Đăng nhập
            </Link>
          </p>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-zinc-400 text-xs">hoặc đăng ký bằng email</span>
            <Separator className="flex-1" />
          </div>
